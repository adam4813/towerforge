...
int main(int argc, char* argv[]) {
    ...
    auto lobby_econ = ecs_world.CreateEntity("Lobby_Econ");
    ...
    auto office_econ = ecs_world.CreateEntity("Office_Econ");
    ...
    auto restaurant_econ = ecs_world.CreateEntity("Restaurant_Econ");
