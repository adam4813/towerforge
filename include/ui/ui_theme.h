...
namespace towerforge::ui {
    ...
    public:
        ...
        static engine::ui::Color ToEngineColor(const Color raylib_color) {
            return engine::ui::Color{
                static_cast<float>(raylib_color.r) / 255.0f,
                static_cast<float>(raylib_color.g) / 255.0f,
                static_cast<float>(raylib_color.b) / 255.0f,
                static_cast<float>(raylib_color.a) / 255.0f
            };
        }
    };
