...
public:
     ...
     */
    void Render(TowerForge::Core::ResearchTree& research_tree);
...
private:
    void RenderOverlay();
    void RenderHeader(const TowerForge::Core::ResearchTree& research_tree);
    void RenderTreeGrid(const TowerForge::Core::ResearchTree& research_tree);
    void RenderNode(const TowerForge::Core::ResearchNode& node, int x, int y, bool hovered);
    void RenderNodeDetails(const TowerForge::Core::ResearchNode& node);
