...
*/
   struct NotificationFilter {
      ...
      bool ShouldShow(const NotificationEntry &entry) const {
         ...
         switch (entry.type) {
            case NotificationType::Info: type_match = show_info;
               break;
            case NotificationType::Warning: type_match = show_warning;
               break;
            case NotificationType::Error: type_match = show_error;
               break;
            case NotificationType::Success: type_match = show_success;
               break;
            case NotificationType::Achievement: type_match = show_achievement;
               break;
            case NotificationType::Event: type_match = show_event;
               break;
         }
...
*/
   ...
   */
      ...
      /**
   * @brief Shutdown and cleanup UI elements
   */
      void Shutdown();
   ...
   */
   ...
   private:
      ...
      std::unique_ptr<engine::ui::elements::Container> CreateNotificationItem(
         NotificationEntry &entry, float item_width);

      void UpdateLayout();

      static engine::ui::Color GetTypeColor(NotificationType type);
      ...
      engine::ui::elements::Container *notification_list_container_;
      engine::ui::elements::Container *filter_container_;
      std::vector<engine::ui::elements::Button *> filter_buttons_;
