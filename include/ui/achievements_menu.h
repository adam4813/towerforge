...
private:
    ...
    void RenderAchievementItem(const TowerForge::Core::Achievement& achievement, int y_pos, bool is_unlocked);
    void RenderFooter();
    std::string GetProgressText(const TowerForge::Core::Achievement& achievement);
